...
| `FR-23` | [PA-SERVICE-001](../service/README.md), [route manifest](../service/public-pages.json) | SSR service routes, shared footer, pre-chat notice and cookie controls | Content contract, SSR, link, accessibility and storage-behavior tests | Bilingual parity; zero unresolved placeholders/non-essential storage before consent | Source copy ready; UI/deployment/reviews pending |
...
| `AC-95–AC-101` | [PA-REPO-001](../engineering/repository-conventions.md), PA-TRACE-001 | Repository validator, CI, branch/security settings and future app suites | Coverage/change/layout/quality/dependency/secret/protection tests | 135/135 mapped IDs; required checks passing; leaked secrets 0 | Base validator/workflow implemented; app suites/settings evidence pending |
| `AC-102–AC-112` | [PA-SERVICE-001](../service/README.md), [route manifest](../service/public-pages.json) | SSR legal/safety/source pages, footer, disclosure and preferences | Manifest/content, route, no-JS, link, accessibility, consent and snapshot tests | BG/EN parity; required review records; unresolved placeholders 0 | Source contract ready; implementation and qualified reviews pending |
<!-- traceability-end -->
